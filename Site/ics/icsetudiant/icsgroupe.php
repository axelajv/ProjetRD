...
if(	isset($_POST['idgrp']) &&
    ...
    // si aucun groupe n'est précisé => EXPORT TOUS LES CALENDRIERS
    $requete_precision_grp = "";
}

$ressources_groupes = mysql_query("SELECT * FROM ressources_groupes WHERE deleted='0' $requete_precision_grp ;");
